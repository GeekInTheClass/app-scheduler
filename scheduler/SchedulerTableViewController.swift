...
class SchedulerTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let App = manager[indexPath.row]
        cell.textLabel?.text = App.name
        cell.detailTextLabel?.text = String(App.totaltime) + "분"
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let dest = segue.destination as! DDController
        let item = manager[self.tableView.indexPathForSelectedRow!.row]
        dest.tmp = item
    }
